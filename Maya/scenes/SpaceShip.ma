...
//Name: SpaceShip.ma
//Last modified: Mon, Mar 24, 2014 04:07:18 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.0906893633927495 4.897659543030823 19.357973389371463 ;
	setAttr ".r" -type "double3" -12.938352728763181 -354.99999999998812 -9.9771996363890612e-17 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 19.984081693387235;
...
createNode camera -s -n "topShape" -p "top";
	...
	setAttr ".tp" -type "double3" 9.7385432062541462 1.480679628307513 -0.48142576527800107 ;
...
createNode mesh -n "pPlaneShape1" -p "pPlane1";
	...
	setAttr ".pt[35]" -type "float3" -1.5319591 0.16823508 0.28145269 ;
	setAttr ".dn" yes;
...
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 7 ".pt[14:20]" -type "float3"  -1.2836954e-15 1.5730313 
		0 -1.2836954e-15 1.5730313 0 -1.4710455e-15 1.5730313 0 0 1.5730313 0 0 1.5730313 
		0 0 1.5730313 0 -1.4710455e-15 1.5730313 0;
	setAttr ".dn" yes;
...
createNode mesh -n "pPlaneShape4" -p "pPlane4";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 7 ".pt[14:20]" -type "float3"  0.17275104 0.24751702 -0.092648327 
		0.17275095 0.19067135 0.2211017 0.17275095 0.19067135 0.2211017 0.17275095 0.19067135 
		0.2211017 0.17275095 0.19067135 0.2211017 0.17275095 0.19067135 0.2211017 0.17275095 
		0.19067135 0.024701059;
	setAttr ".dn" yes;
...
createNode mesh -n "pPlaneShape6" -p "pPlane6";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 23 ".pt";
	setAttr ".pt[14]" -type "float3" 0 0.12389988 0 ;
	setAttr ".pt[15]" -type "float3" 0 0.12389988 0 ;
	setAttr ".pt[16]" -type "float3" 0 0.12389988 0 ;
	setAttr ".pt[21]" -type "float3" 0 0.099830948 0 ;
...
createNode transform -n "pPlane8";
	setAttr ".t" -type "double3" 16.639350538363669 0 -1.3483483314343836 ;
...
createNode transform -n "pPlane10";
	setAttr ".t" -type "double3" 2.6557035889637062 0 -1.6853801831282065 ;
...
createNode polySplitRing -n "polySplitRing40";
	...
	setAttr ".ix" -type "matrix" -1 -1.2246467991473532e-16 -0 0 1.2246467991473532e-16 -1 0 0
		 0 -0 1 0 2.6557035889637062 0 -1.6853801831282065 1;
...
createNode polyExtrudeFace -n "polyExtrudeFace3";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 0.020990892888266721 0.85897862911224343 -1.6503237113035605 ;
...
createNode polyExtrudeFace -n "polyExtrudeFace4";
	...
	setAttr ".c[0]"  0 1 1;
	setAttr ".cbn" -type "double3" 0.017775341511923948 0.85897862911224332 -0.87678530063995574 ;
...
createNode polyTweak -n "polyTweak12";
	setAttr ".uopa" yes;
	setAttr -s 26 ".tk";
	setAttr ".tk[127]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[128]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[129]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[130]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[131]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[132]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[133]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[134]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[135]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[136]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[137]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[138]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[139]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[140]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[141]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[142]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[143]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[144]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[145]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[146]" -type "float3" 0 -0.44380534 0 ;
	setAttr ".tk[147]" -type "float3" 0 -0.44380534 0 ;
...
createNode polyTweak -n "polyTweak13";
	setAttr ".uopa" yes;
	setAttr -s 18 ".tk";
	setAttr ".tk[148]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[149]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[150]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[151]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[152]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[153]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[154]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[155]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[156]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[157]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[158]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[159]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[160]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[161]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[162]" -type "float3" 0 0.43011171 0 ;
	setAttr ".tk[163]" -type "float3" 0 0.43011171 0 ;
...
connectAttr "polySplitRing37.out" "pPlaneShape1.i";
connectAttr "polySplitRing36.out" "pPlaneShape2.i";
connectAttr "polySplitRing38.out" "pPlaneShape4.i";
connectAttr "polySplitRing39.out" "pPlaneShape6.i";
connectAttr "deleteComponent3.og" "pPlaneShape10.i";
...
connectAttr "pPlaneShape6.wm" "polySplitRing1.mp";
...
connectAttr "pPlaneShape6.wm" "polySplitRing5.mp";
connectAttr "polyTweak1.out" "polySplitRing6.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing6.mp";
connectAttr "polySplitRing5.out" "polyTweak1.ip";
connectAttr "polySplitRing6.out" "polySplitRing7.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing7.mp";
connectAttr "polySplitRing7.out" "polySplitRing8.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing8.mp";
connectAttr "polySplitRing8.out" "polySplitRing9.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing9.mp";
connectAttr "polySplitRing9.out" "polySplitRing10.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing10.mp";
connectAttr "polySplitRing10.out" "polySplitRing11.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing11.mp";
connectAttr "polySplitRing11.out" "polySplitRing12.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing12.mp";
connectAttr "polySplitRing12.out" "polySplitRing13.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing13.mp";
connectAttr "polySplitRing13.out" "polySplitRing14.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing14.mp";
connectAttr "polySplitRing14.out" "polySplitRing15.ip";
connectAttr "pPlaneShape6.wm" "polySplitRing15.mp";
...
connectAttr "pPlaneShape4.wm" "polySplitRing18.mp";
connectAttr "polySplitRing18.out" "polySplitRing19.ip";
connectAttr "pPlaneShape4.wm" "polySplitRing19.mp";
connectAttr "polySplitRing19.out" "polySplitRing20.ip";
connectAttr "pPlaneShape4.wm" "polySplitRing20.mp";
...
connectAttr "pPlaneShape2.wm" "polySplitRing31.mp";
connectAttr "polySplitRing31.out" "polySplitRing32.ip";
connectAttr "pPlaneShape2.wm" "polySplitRing32.mp";
connectAttr "polySplitRing32.out" "polySplitRing33.ip";
connectAttr "pPlaneShape2.wm" "polySplitRing33.mp";
connectAttr "polySplitRing33.out" "polySplitRing34.ip";
connectAttr "pPlaneShape2.wm" "polySplitRing34.mp";
connectAttr "polySplitRing34.out" "polySplitRing35.ip";
connectAttr "pPlaneShape2.wm" "polySplitRing35.mp";
connectAttr "polyTweak3.out" "polySplitRing36.ip";
connectAttr "pPlaneShape2.wm" "polySplitRing36.mp";
...
connectAttr "pPlaneShape6.msg" "hyperLayout1.hyp[12].dn";
...
connectAttr "pPlaneShape4.wm" "polySplitRing38.mp";
...
connectAttr "pPlaneShape10.wm" "polySplitRing46.mp";
connectAttr "polySplitRing46.out" "polySplitRing47.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing47.mp";
connectAttr "polySplitRing47.out" "polySplitRing48.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing48.mp";
connectAttr "polySplitRing48.out" "polySplitRing49.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing49.mp";
connectAttr "polySplitRing49.out" "polySplitRing50.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing50.mp";
connectAttr "polySplitRing50.out" "polySplitRing51.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing51.mp";
connectAttr "polySplitRing51.out" "polySplitRing52.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing52.mp";
connectAttr "polySplitRing52.out" "polySplitRing53.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing53.mp";
connectAttr "polySplitRing53.out" "polySplitRing54.ip";
connectAttr "pPlaneShape10.wm" "polySplitRing54.mp";
connectAttr "polyTweak8.out" "polyExtrudeFace1.ip";
connectAttr "pPlaneShape10.wm" "polyExtrudeFace1.mp";
connectAttr "polySplitRing54.out" "polyTweak8.ip";
connectAttr "polyTweak9.out" "polyExtrudeFace2.ip";
connectAttr "pPlaneShape10.wm" "polyExtrudeFace2.mp";
connectAttr "polyExtrudeFace1.out" "polyTweak9.ip";
connectAttr "polyTweak10.out" "polyExtrudeFace3.ip";
connectAttr "pPlaneShape10.wm" "polyExtrudeFace3.mp";
connectAttr "polyExtrudeFace2.out" "polyTweak10.ip";
connectAttr "polyTweak11.out" "polyExtrudeFace4.ip";
connectAttr "pPlaneShape10.wm" "polyExtrudeFace4.mp";
...
connectAttr "pPlaneShape10.wm" "polySplitRing55.mp";
