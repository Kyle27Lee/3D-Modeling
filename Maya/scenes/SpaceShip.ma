...
//Name: SpaceShip.ma
//Last modified: Mon, Mar 24, 2014 03:53:47 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 7.6859798658789007 6.7176075445362526 20.944115378319641 ;
	setAttr ".r" -type "double3" -19.538352729214242 -340.59999999989833 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 23.754584596336105;
...
createNode transform -s -n "top";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.13227513227513121 100.1 -1.005291005291006 ;
...
createNode mesh -n "pPlaneShape4" -p "pPlane4";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 10 ".pt";
	setAttr ".pt[1]" -type "float3" 0 -0.56639034 0 ;
	setAttr ".pt[3]" -type "float3" 1.7763568e-15 -0.4471429 0.26611429 ;
	setAttr ".pt[4]" -type "float3" 0 -2.9802322e-08 0 ;
	setAttr ".pt[5]" -type "float3" 9.0614698e-08 0.34922454 -0.018211277 ;
	setAttr ".pt[7]" -type "float3" 8.8817842e-16 3.349225 0.21780869 ;
	setAttr ".pt[9]" -type "float3" -1.4780389e-07 1.349225 0.077986151 ;
	setAttr ".pt[10]" -type "float3" 0 -0.56639034 8.8817842e-16 ;
	setAttr ".pt[11]" -type "float3" -1.4780389e-07 0.34922409 -0.063841909 ;
	setAttr ".pt[12]" -type "float3" 0 -0.56639034 8.8817842e-16 ;
	setAttr ".pt[13]" -type "float3" -1.4780389e-07 -6.4437078e-10 -0.14944586 ;
	setAttr ".dn" yes;
...
createNode mesh -n "pPlaneShape6" -p "pPlane6";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 54 ".pt";
	setAttr ".pt[2]" -type "float3" 0 -0.046355505 0 ;
	setAttr ".pt[5]" -type "float3" 0 -0.046355505 0 ;
	setAttr ".pt[9]" -type "float3" 0 0.41602501 0 ;
	setAttr ".pt[11]" -type "float3" 0 0.57294512 0 ;
	setAttr ".pt[13]" -type "float3" 2.9802322e-08 0.47206095 0 ;
	setAttr ".pt[18]" -type "float3" 0 0.11137644 0 ;
	setAttr ".pt[19]" -type "float3" 2.9802322e-08 -2.9802322e-08 0 ;
	setAttr ".pt[20]" -type "float3" 0.47619042 0 0 ;
	setAttr ".pt[25]" -type "float3" 0 0.33465576 0 ;
	setAttr ".pt[26]" -type "float3" 2.9802322e-08 -2.9802322e-08 0 ;
	setAttr ".pt[27]" -type "float3" 0.95238119 0 0 ;
	setAttr ".pt[32]" -type "float3" 0 0.49160969 0 ;
	setAttr ".pt[33]" -type "float3" 2.9802322e-08 -2.9802322e-08 0 ;
	setAttr ".pt[34]" -type "float3" 1.3492068 0 0 ;
	setAttr ".pt[35]" -type "float3" 0 -0.11816417 0 ;
	setAttr ".pt[36]" -type "float3" 0 -0.11816417 0 ;
	setAttr ".pt[39]" -type "float3" 0 0.59830588 0 ;
	setAttr ".pt[40]" -type "float3" 2.9802322e-08 -2.9802322e-08 0 ;
	setAttr ".pt[41]" -type "float3" 1.5079371 0 0 ;
	setAttr ".pt[42]" -type "float3" 0 -0.20779991 0 ;
	setAttr ".pt[43]" -type "float3" 0 -0.20779991 0 ;
	setAttr ".pt[46]" -type "float3" 0 0.7602675 0 ;
	setAttr ".pt[47]" -type "float3" 2.9802322e-08 -2.9802322e-08 0 ;
	setAttr ".pt[48]" -type "float3" 1.7724875 0 0 ;
	setAttr ".pt[49]" -type "float3" 0 -0.48693117 0 ;
	setAttr ".pt[50]" -type "float3" 0 -0.48693117 0 ;
	setAttr ".pt[52]" -type "float3" 0 0.057195578 0 ;
	setAttr ".pt[53]" -type "float3" 0 0.91913319 0 ;
	setAttr ".pt[54]" -type "float3" 2.9802322e-08 0.1985978 0 ;
	setAttr ".pt[55]" -type "float3" 1.9047627 0 0 ;
	setAttr ".pt[56]" -type "float3" 0 -0.65518379 0 ;
	setAttr ".pt[57]" -type "float3" 0 -0.65518379 0 ;
	setAttr ".pt[59]" -type "float3" 0 0.14473388 0 ;
	setAttr ".pt[60]" -type "float3" 0 1.0329623 0 ;
	setAttr ".pt[61]" -type "float3" 2.9802322e-08 0.28832111 0 ;
	setAttr ".pt[62]" -type "float3" 1.7724875 0 0 ;
	setAttr ".pt[63]" -type "float3" 0 -0.65518379 0 ;
	setAttr ".pt[64]" -type "float3" 0 -0.65518379 0 ;
	setAttr ".pt[66]" -type "float3" 0 0.26307017 0 ;
	setAttr ".pt[67]" -type "float3" 0 1.1467272 0 ;
	setAttr ".pt[68]" -type "float3" 2.9802322e-08 0.37648964 0 ;
	setAttr ".pt[69]" -type "float3" 1.5079371 0 0 ;
	setAttr ".pt[70]" -type "float3" 0 -0.48693117 0 ;
	setAttr ".pt[71]" -type "float3" 0 -0.48693117 0 ;
	setAttr ".pt[73]" -type "float3" 0 0.3221845 0 ;
	setAttr ".pt[74]" -type "float3" 0 1.1467272 0 ;
	setAttr ".pt[75]" -type "float3" 2.9802322e-08 0.47206095 0 ;
	setAttr ".pt[76]" -type "float3" 0.95238119 0 0 ;
	setAttr ".pt[77]" -type "float3" 0 -0.17238992 0 ;
	setAttr ".pt[78]" -type "float3" 0 -0.17238992 0 ;
	setAttr ".pt[80]" -type "float3" 0 0.41602501 0 ;
	setAttr ".pt[81]" -type "float3" 0 0.94038111 0 ;
	setAttr ".pt[82]" -type "float3" 2.9802322e-08 0.47206095 0 ;
	setAttr ".pt[83]" -type "float3" 0.47619042 0 0 ;
	setAttr ".dn" yes;
...
connectAttr "polySplitRing20.out" "pPlaneShape4.i";
connectAttr "polySplitRing15.out" "pPlaneShape6.i";
