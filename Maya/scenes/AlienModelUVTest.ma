...
//Name: AlienModelUVTest.ma
//Last modified: Tue, Feb 11, 2014 07:17:34 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -4.2518107531830092 5.7406491155046933 19.745566597279705 ;
	setAttr ".r" -type "double3" 1.4616472703448935 343.39999999974464 -2.5928725995873733e-17 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 20.409125054123344;
...
createNode file -n "file1";
	setAttr ".ftn" -type "string" "/Users/temp/Desktop/3D-Modeling/Maya/scenes//scenes/3dPaintTextures/AlienModelUVTest/pCubeShape1_color.iff";
