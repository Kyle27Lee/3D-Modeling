...
//Name: Plane.ma
//Last modified: Tue, Jan 21, 2014 06:46:12 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -23.502329121635906 15.289130417077732 26.573537872635008 ;
	setAttr ".r" -type "double3" -18.33835272955811 684.59999999989054 9.7547731108380389e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 34.028763708335291;
...
createNode mesh -n "pCubeShape1" -p "pCube1";
	...
	setAttr ".pt[12]" -type "float3" 0.14439969 0 9.5367432e-07 ;
	setAttr ".pt[13]" -type "float3" -0.14439967 0 9.5367432e-07 ;
	setAttr ".pt[16]" -type "float3" 0.14439969 0 9.5367432e-07 ;
	setAttr ".pt[17]" -type "float3" -0.14439967 0 9.5367432e-07 ;
	setAttr ".pt[28]" -type "float3" 0 -0.10224958 0 ;
	setAttr ".pt[30]" -type "float3" -2.9802322e-08 -0.047012534 9.5367432e-07 ;
	setAttr ".pt[31]" -type "float3" 0.14439969 0 9.5367432e-07 ;
	setAttr ".pt[32]" -type "float3" -0.14439973 0 9.5367432e-07 ;
	setAttr ".pt[33]" -type "float3" 1.4901161e-08 -0.047012534 9.5367432e-07 ;
	setAttr ".pt[35]" -type "float3" 0 -0.10224958 0 ;
	setAttr ".pt[38]" -type "float3" 0 0.10224979 0 ;
	setAttr ".pt[40]" -type "float3" -2.9802322e-08 0.047012534 9.5367432e-07 ;
	setAttr ".pt[41]" -type "float3" 0.14439969 0 9.5367432e-07 ;
	setAttr ".pt[42]" -type "float3" -0.14439973 0 9.5367432e-07 ;
	setAttr ".pt[43]" -type "float3" 1.4901161e-08 0.047012534 9.5367432e-07 ;
	setAttr ".pt[45]" -type "float3" 0 0.10224979 0 ;
	setAttr ".pt[46]" -type "float3" 0 0.094626009 0.01125904 ;
	setAttr ".pt[47]" -type "float3" 0 0.10224979 0 ;
	setAttr ".pt[48]" -type "float3" 0 -0.094626009 0.01125904 ;
	setAttr ".pt[49]" -type "float3" 0 -0.10224958 0 ;
	setAttr ".pt[50]" -type "float3" 0 0.10224979 0 ;
	setAttr ".pt[51]" -type "float3" 0 0.10543287 0 ;
	setAttr ".pt[52]" -type "float3" 0 -0.10224958 0 ;
	setAttr ".pt[53]" -type "float3" 0 -0.10543287 0 ;
	setAttr ".pt[56]" -type "float3" -0.14439967 0 4.7683716e-07 ;
	setAttr ".pt[57]" -type "float3" 0.14439969 0 4.7683716e-07 ;
	setAttr ".pt[59]" -type "float3" -9.5367432e-07 0.047012534 1.1920929e-07 ;
	setAttr ".pt[61]" -type "float3" -9.5367432e-07 -0.047012534 1.1920929e-07 ;
	setAttr ".pt[64]" -type "float3" 9.5367432e-07 0.047012534 1.1920929e-07 ;
	setAttr ".pt[65]" -type "float3" 9.5367432e-07 -0.047012534 1.1920929e-07 ;
	setAttr ".pt[66]" -type "float3" 0 0.10335231 0 ;
	setAttr ".pt[67]" -type "float3" 0 0.10224979 0 ;
	setAttr ".pt[68]" -type "float3" 0 -0.11911903 0 ;
	setAttr ".pt[69]" -type "float3" 0 -0.12763989 0 ;
	setAttr ".pt[70]" -type "float3" 0 0.10224979 0 ;
	setAttr ".pt[71]" -type "float3" 0 0.094805986 0 ;
	setAttr ".pt[72]" -type "float3" 0 -0.12829903 0 ;
	setAttr ".pt[73]" -type "float3" 0 -0.12256387 0 ;
	setAttr ".pt[74]" -type "float3" 0 0.10335231 0 ;
	setAttr ".pt[75]" -type "float3" 0 0.11416123 0 ;
	setAttr ".pt[76]" -type "float3" 0 -0.11911903 0 ;
	setAttr ".pt[77]" -type "float3" 0 -0.12168554 0 ;
	setAttr ".pt[78]" -type "float3" 0 0.11317625 0 ;
	setAttr ".pt[79]" -type "float3" 0 0.094805986 0 ;
	setAttr ".pt[80]" -type "float3" 0 -0.12906662 0 ;
	setAttr ".pt[81]" -type "float3" 0 -0.12256387 0 ;
	setAttr ".pt[82]" -type "float3" -0.14439967 0 7.4505806e-09 ;
	setAttr ".pt[85]" -type "float3" 0.14439969 0 7.4505806e-09 ;
	setAttr ".pt[87]" -type "float3" 0 0.047012534 0 ;
	setAttr ".pt[89]" -type "float3" 0 -0.047012534 0 ;
	setAttr ".pt[92]" -type "float3" 0 0.047012534 0 ;
	setAttr ".pt[93]" -type "float3" 0 -0.047012534 0 ;
	setAttr ".pt[122]" -type "float3" 0 -0.09946195 0 ;
	setAttr ".pt[123]" -type "float3" 0 -0.094866991 0 ;
	setAttr ".pt[124]" -type "float3" 0 -0.11750533 0 ;
	setAttr ".pt[125]" -type "float3" 0 -0.09946195 0 ;
	setAttr ".pt[126]" -type "float3" 0 -0.11169732 0 ;
	setAttr ".pt[127]" -type "float3" 0 -0.095819131 0 ;
	setAttr ".pt[128]" -type "float3" 0 -0.095819131 0 ;
	setAttr ".pt[129]" -type "float3" 0 -0.12732911 0 ;
	...
	setAttr ".pt[139]" -type "float3" 0 -0.099461749 0 ;
	setAttr ".pt[140]" -type "float3" 0 -0.11911903 0 ;
	setAttr ".pt[141]" -type "float3" 0 0.10335231 0 ;
	setAttr ".pt[145]" -type "float3" 0.70331442 0 0 ;
	setAttr ".pt[146]" -type "float3" -0.70331442 0 0 ;
	setAttr ".pt[150]" -type "float3" 0 0.094805986 0 ;
	setAttr ".pt[151]" -type "float3" 0 -0.12256387 0 ;
	setAttr ".pt[152]" -type "float3" 0 -0.095818952 0 ;
	...
	setAttr ".pt[167]" -type "float3" 0 -0.099461749 0 ;
	setAttr ".pt[168]" -type "float3" 0 -0.11911903 0 ;
	setAttr ".pt[169]" -type "float3" 0 0.10335231 0 ;
	setAttr ".pt[173]" -type "float3" 0.70331442 0 0 ;
	setAttr ".pt[174]" -type "float3" -0.70331442 0 0 ;
	setAttr ".pt[178]" -type "float3" 0 0.094805986 0 ;
	setAttr ".pt[179]" -type "float3" 0 -0.12256387 0 ;
	setAttr ".pt[180]" -type "float3" 0 -0.095818952 0 ;
	setAttr ".pt[184]" -type "float3" 0.73108953 0 0 ;
	setAttr ".pt[185]" -type "float3" 0.73108953 0 0 ;
	setAttr ".pt[194]" -type "float3" 0.11639152 0 -2.3841858e-07 ;
	setAttr ".pt[195]" -type "float3" -0.11639152 0 -2.3841858e-07 ;
	setAttr ".pt[196]" -type "float3" -0.11639152 0 -2.3841858e-07 ;
	setAttr ".pt[197]" -type "float3" 0.11639152 0 -2.3841858e-07 ;
