...
//Last modified: Mon, Feb 24, 2014 08:41:56 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -3.9715983313167387 20.286642416480738 16.97741584905242 ;
	setAttr ".r" -type "double3" -16.538352729663849 347.39999999962123 -2.0369018685247272e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 20.460254386549192;
...
createNode brush -n "art3dPaintLastPaintBrush";
	setAttr ".cl1" -type "float3" 0.1551058 0.41176471 0.15340254 ;
...
createNode polyAutoProj -n "polyAutoProj4";
	...
	setAttr ".ix" -type "matrix" 1 0 0 0 0 0.48199004779255517 0.08543132679240989 0
...
connectAttr "file5.oc" "AlienHead.c";
...
connectAttr "file4.oc" "AlienBody.c";
