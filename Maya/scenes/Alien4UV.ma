...
//Name: Alien4UV.ma
//Last modified: Thu, Apr 17, 2014 12:06:04 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 11.235403889900827 14.905700745255329 20.54439391532043 ;
	setAttr ".r" -type "double3" -19.538352732068429 26.599999999997202 8.892634375658657e-16 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 23.226440316224327;
...
createNode joint -n "Clav_L" -p "UpperBack";
	setAttr ".ove" yes;
	setAttr ".ovc" 13;
	setAttr ".t" -type "double3" 2.1780799741760122 -0.11083092230434777 -0.29113577059993057 ;
	setAttr ".r" -type "double3" 0 0 7 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".jo" -type "double3" 90 89.999999999999915 0 ;
	setAttr ".radi" 0.5;
...
createNode joint -n "Clav_R" -p "UpperBack";
	setAttr ".ove" yes;
	setAttr ".ovc" 30;
	setAttr ".t" -type "double3" 2.1780799741760122 -0.11083092230434777 0.29100000000000531 ;
...
createNode joint -n "Neck1" -p "UpperBack";
	setAttr ".ove" yes;
	setAttr ".ovc" 6;
	setAttr ".t" -type "double3" 2.1827559971184973 1.1102230246251565e-16 5.3902069725005173e-15 ;
