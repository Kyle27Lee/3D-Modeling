...
//Name: Alien4UV.ma
//Last modified: Thu, Apr 17, 2014 11:33:15 AM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -1.6633537157924889 10.835332459802576 19.641500194674567 ;
	setAttr ".r" -type "double3" -11.138352732067991 -2.2000000000026336 -4.9732824146399295e-17 ;
	setAttr ".rp" -type "double3" -2.2204460492503131e-16 0 -3.5527136788005009e-15 ;
	setAttr ".rpt" -type "double3" -8.1362116363581335e-16 -1.5984259396744256e-15 5.4547088492354824e-16 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 18.899728948250825;
...
createNode joint -n "Clav_L";
	setAttr ".ove" yes;
	setAttr ".ovc" 13;
	setAttr ".t" -type "double3" 0.29113577059993589 8.632553134547436 -0.54406493603213235 ;
...
createNode joint -n "Shoulder_L" -p "Clav_L";
	setAttr ".t" -type "double3" 0.71291924944404084 -3.5527136788005009e-15 0 ;
	setAttr ".r" -type "double3" 6.2125296762907787e-18 -1 -5.5000000000000027 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Elbow_L" -p "|Clav_L|Shoulder_L";
	setAttr ".t" -type "double3" 2.0100953871235143 0 0 ;
	setAttr ".r" -type "double3" 1.5908732372178921e-18 -7.9520471509425476e-15 -1.5000000000000024 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Wrist_L" -p "|Clav_L|Shoulder_L|Elbow_L";
	setAttr ".t" -type "double3" 1.5004375772900893 0 -1.1102230246251565e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "HIp_L";
	setAttr ".ove" yes;
	setAttr ".ovc" 13;
	setAttr ".t" -type "double3" 0.28251805807909114 4.9025623709048194 -0.65489585833648023 ;
	setAttr ".r" -type "double3" 90 -1.5000000000000002 -88 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "KNee_L" -p "HIp_L";
	setAttr ".t" -type "double3" 2.5261003007352558 3.3306690738754696e-16 1.1102230246251565e-16 ;
	setAttr ".r" -type "double3" 0 -3.5295172227886615 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Ankle_L" -p "|HIp_L|KNee_L";
	setAttr ".t" -type "double3" 2.028062161315666 2.2204460492503131e-16 0 ;
	setAttr ".r" -type "double3" 0 0 87.646909360300754 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Toe_L" -p "|HIp_L|KNee_L|Ankle_L";
	setAttr ".ove" yes;
	setAttr ".ovc" 13;
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "LowerBack";
	setAttr ".ove" yes;
	setAttr ".ovc" 6;
	setAttr ".t" -type "double3" 0 4.9025623709048194 -0.65489585833648023 ;
	setAttr ".r" -type "double3" -90 -3.1805546814635168e-15 89.999999999999915 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "MidBack" -p "LowerBack";
	setAttr ".t" -type "double3" 0.69878179190530698 -1.1102230246251565e-16 -2.3665827156630354e-30 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "UpperBack" -p "MidBack";
	setAttr ".t" -type "double3" 0.85312899756129745 0 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Neck1";
	setAttr ".ove" yes;
	setAttr ".ovc" 6;
	setAttr ".t" -type "double3" 0 8.6372291574899211 -0.65489585833648023 ;
...
createNode joint -n "Neck2" -p "Neck1";
	setAttr ".t" -type "double3" 0.68709141692726128 3.944304526105059e-31 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.25;
createNode joint -n "Head" -p "Neck2";
	setAttr ".ove" yes;
	setAttr ".ovc" 6;
	setAttr ".t" -type "double3" 0.88638912666929315 3.944304526105059e-31 0 ;
...
createNode joint -n "Pelvis1";
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.75;
createNode joint -n "HIp_L1";
	setAttr ".ove" yes;
	setAttr ".ovc" 30;
	setAttr ".t" -type "double3" -0.283 4.9025623709048194 -0.65489585833648023 ;
	setAttr ".r" -type "double3" 90.064417858965243 -1.4986164571983274 -90.461618769085604 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "KNee_L" -p "HIp_L1";
	setAttr ".t" -type "double3" 2.5261003007352558 3.3306690738754696e-16 1.1102230246251565e-16 ;
	setAttr ".r" -type "double3" 0 0.47914919249108989 0 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Ankle_L" -p "|HIp_L1|KNee_L";
	setAttr ".t" -type "double3" 2.028062161315666 2.2204460492503131e-16 0 ;
	setAttr ".r" -type "double3" 0 0 87.646909360300754 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Toe_L" -p "|HIp_L1|KNee_L|Ankle_L";
	setAttr ".ove" yes;
	setAttr ".ovc" 13;
	setAttr ".t" -type "double3" 0.57425417555039671 0 5.5511151231257827e-17 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	...
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Clav_L1";
	setAttr ".ove" yes;
	setAttr ".ovc" 30;
	setAttr ".t" -type "double3" -0.291 8.632553134547436 -0.54406493603213235 ;
	setAttr ".r" -type "double3" 0 -180 -6.1850860489203212 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Shoulder_L" -p "Clav_L1";
	setAttr ".t" -type "double3" 0.71291924944404084 -3.5527136788005009e-15 0 ;
	setAttr ".r" -type "double3" 6.2125296762907787e-18 -1 -5.5000000000000027 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Elbow_L" -p "|Clav_L1|Shoulder_L";
	setAttr ".t" -type "double3" 2.0100953871235143 0 0 ;
	setAttr ".r" -type "double3" 1.5908732372178921e-18 -7.9520471509425476e-15 -1.5000000000000024 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
	setAttr ".radi" 0.5;
createNode joint -n "Wrist_L" -p "|Clav_L1|Shoulder_L|Elbow_L";
	setAttr ".t" -type "double3" 1.5004375772900893 0 -1.1102230246251565e-16 ;
	setAttr ".mnrl" -type "double3" -360 -360 -360 ;
	setAttr ".mxrl" -type "double3" 360 360 360 ;
	setAttr ".dla" yes;
...
connectAttr "Clav_L.s" "|Clav_L|Shoulder_L.is";
connectAttr "|Clav_L|Shoulder_L.s" "|Clav_L|Shoulder_L|Elbow_L.is";
connectAttr "|Clav_L|Shoulder_L|Elbow_L.s" "|Clav_L|Shoulder_L|Elbow_L|Wrist_L.is"
		;
connectAttr "HIp_L.s" "|HIp_L|KNee_L.is";
connectAttr "|HIp_L|KNee_L.s" "|HIp_L|KNee_L|Ankle_L.is";
connectAttr "|HIp_L|KNee_L|Ankle_L.s" "|HIp_L|KNee_L|Ankle_L|Toe_L.is";
...
connectAttr "HIp_L1.s" "|HIp_L1|KNee_L.is";
connectAttr "|HIp_L1|KNee_L.s" "|HIp_L1|KNee_L|Ankle_L.is";
connectAttr "|HIp_L1|KNee_L|Ankle_L.s" "|HIp_L1|KNee_L|Ankle_L|Toe_L.is";
connectAttr "Clav_L1.s" "|Clav_L1|Shoulder_L.is";
connectAttr "|Clav_L1|Shoulder_L.s" "|Clav_L1|Shoulder_L|Elbow_L.is";
connectAttr "|Clav_L1|Shoulder_L|Elbow_L.s" "|Clav_L1|Shoulder_L|Elbow_L|Wrist_L.is"
		;
