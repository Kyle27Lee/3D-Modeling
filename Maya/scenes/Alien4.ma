...
//Name: Alien4.ma
//Last modified: Thu, Apr 03, 2014 12:09:44 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.3935698283792375 11.463288253556712 23.637087205605944 ;
	setAttr ".r" -type "double3" 354.2616472689449 -347.40000000006285 359.99999999998556 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 24.325621068186205;
...
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 57 ".pt";
	setAttr ".pt[4]" -type "float3" -1.7695129e-08 0 0 ;
	setAttr ".pt[8]" -type "float3" -0.092026606 0 0 ;
	setAttr ".pt[18]" -type "float3" -1.7229468e-08 0 0 ;
	setAttr ".pt[20]" -type "float3" -0.0021528169 0 0 ;
	setAttr ".pt[22]" -type "float3" -0.0031029149 0 0 ;
	setAttr ".pt[23]" -type "float3" 0.0095777437 0 0 ;
	setAttr ".pt[24]" -type "float3" 0.0094900746 0 0 ;
	setAttr ".pt[25]" -type "float3" 0.0013331682 0 0 ;
	setAttr ".pt[26]" -type "float3" 0.00063536922 0 0 ;
	setAttr ".pt[27]" -type "float3" 0.0008878248 0 0 ;
	setAttr ".pt[28]" -type "float3" 0.0008878248 0 0 ;
	setAttr ".pt[29]" -type "float3" 0.00063536922 0 0 ;
	setAttr ".pt[30]" -type "float3" 0.0013331682 0 0 ;
	setAttr ".pt[31]" -type "float3" 0.0094900746 0 0 ;
	setAttr ".pt[32]" -type "float3" 0.0095777437 0 0 ;
	setAttr ".pt[33]" -type "float3" -0.0031029149 0 0 ;
	setAttr ".pt[34]" -type "float3" -0.0029819175 0 0 ;
	setAttr ".pt[35]" -type "float3" 0.025101788 0 0 ;
	setAttr ".pt[37]" -type "float3" 0.00044852961 0 0 ;
	setAttr ".pt[48]" -type "float3" -0.075508982 0 0 ;
	setAttr ".pt[49]" -type "float3" -0.075508997 0 0 ;
	setAttr ".pt[50]" -type "float3" -0.0094386237 0 0 ;
	setAttr ".pt[60]" -type "float3" -0.0083449669 0.06675972 0 ;
	setAttr ".pt[61]" -type "float3" -0.032187723 0 0 ;
	setAttr ".pt[62]" -type "float3" 0.013354721 0 0 ;
	setAttr ".pt[66]" -type "float3" 0.013958207 0 0 ;
	setAttr ".pt[67]" -type "float3" 0.014561694 0 0 ;
	setAttr ".pt[71]" -type "float3" 0.014561694 0 0 ;
	setAttr ".pt[72]" -type "float3" 0.030997254 0 0 ;
	setAttr ".pt[76]" -type "float3" -0.0023224731 0 0 ;
	setAttr ".pt[77]" -type "float3" 0.0058091828 0 0 ;
	setAttr ".pt[82]" -type "float3" 0.012191415 0 0 ;
	setAttr ".pt[87]" -type "float3" 0.0095440801 0 0 ;
	setAttr ".pt[90]" -type "float3" 0.0091670211 0 0 ;
	setAttr ".pt[92]" -type "float3" 0.0095440801 0 0 ;
	setAttr ".pt[104]" -type "float3" -0.014157935 0 0 ;
	setAttr ".pt[116]" -type "float3" 0.11326353 0 0 ;
	setAttr ".pt[119]" -type "float3" 0 -0.06135105 0 ;
	setAttr ".pt[120]" -type "float3" 0.0047193123 0 0 ;
	setAttr ".pt[131]" -type "float3" 0.019095734 0 0 ;
	setAttr ".pt[136]" -type "float3" -0.0052998099 0 0 ;
	setAttr ".pt[140]" -type "float3" 0.023759319 0 0 ;
	setAttr ".pt[141]" -type "float3" -0.0095604155 0 0 ;
	setAttr ".pt[145]" -type "float3" 0.028298991 0 0 ;
	setAttr ".pt[148]" -type "float3" 0.022830419 0 0 ;
	setAttr ".pt[150]" -type "float3" 0.025377465 0 0 ;
	setAttr ".pt[153]" -type "float3" 0.021824662 0 0 ;
	setAttr ".pt[155]" -type "float3" 0.022603391 0 0 ;
	setAttr ".pt[158]" -type "float3" 0.022240371 0 0 ;
	setAttr ".pt[159]" -type "float3" 0.020869669 0 0 ;
	setAttr ".pt[161]" -type "float3" 0.022905927 0 0 ;
	setAttr ".pt[162]" -type "float3" -0.010413805 0 0 ;
	setAttr ".pt[166]" -type "float3" 0.0089413887 0 0 ;
	setAttr ".pt[174]" -type "float3" 0.0072808438 0 0 ;
	setAttr ".pt[187]" -type "float3" 0.012191415 0 0 ;
	setAttr ".pt[251]" -type "float3" 0.029803446 0 0 ;
