...
//Name: Alien4.ma
//Last modified: Thu, Apr 03, 2014 11:56:06 AM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 1.1038522759668061 7.9571771668995526 8.0164437352216176 ;
	setAttr ".r" -type "double3" 366.8616472690386 -353.80000000013723 359.99999999999864 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 7.1790500269237745;
...
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 23 ".pt";
	setAttr ".pt[19]" -type "float3" -0.11326063 0 0 ;
	setAttr ".pt[20]" -type "float3" 0 0 -0.16386366 ;
	setAttr ".pt[23]" -type "float3" 0 0 0.16386366 ;
	setAttr ".pt[24]" -type "float3" 0 0 -0.058608655 ;
	setAttr ".pt[27]" -type "float3" 0 0 0.13872507 ;
	setAttr ".pt[34]" -type "float3" 0 0 0.1094333 ;
	setAttr ".pt[35]" -type "float3" 0 0 -0.096963398 ;
	setAttr ".pt[66]" -type "float3" 0 0 -0.033596028 ;
	setAttr ".pt[67]" -type "float3" 0 0 -0.033596028 ;
	setAttr ".pt[73]" -type "float3" 0 0 -0.016083181 ;
	setAttr ".pt[74]" -type "float3" 0 0 -0.044966884 ;
	setAttr ".pt[75]" -type "float3" 0.10519066 0 0 ;
	setAttr ".pt[79]" -type "float3" 0.053097099 0 0 ;
	setAttr ".pt[80]" -type "float3" 0.053097099 0 0 ;
	setAttr ".pt[81]" -type "float3" 0.053097099 0 0 ;
	setAttr ".pt[86]" -type "float3" 0 0 0.044966884 ;
	setAttr ".pt[87]" -type "float3" 0 0 0.038068444 ;
	setAttr ".pt[119]" -type "float3" -0.032956731 0 0 ;
	setAttr ".pt[120]" -type "float3" -0.032956731 0 0 ;
	setAttr ".pt[121]" -type "float3" -0.032956731 0 0 ;
...
connectAttr "polySplit1.out" "polySurfaceShape1.i";
