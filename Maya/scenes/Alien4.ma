...
//Name: Alien4.ma
//Last modified: Sun, Mar 23, 2014 03:25:04 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 5.4660005157054341 14.362197776456071 23.778607614421261 ;
	setAttr ".r" -type "double3" 350.66164726928974 -707.79999999992629 359.99999999982521 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 25.559481301119369;
...
createNode mesh -n "pCubeShape5" -p "pCube5";
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".pt[272:275]" -type "float3"  0.015660193 0.018861307 -0.027419483 
		0.0090932818 -0.018861307 -0.046081033 -0.015660195 0.019250574 -0.027419483 0.0011818549 
		-0.019250574 -0.046081033;
	setAttr -av ".pt[3].px";
	setAttr -av ".pt[3].py";
	setAttr -av ".pt[3].pz";
	setAttr -av ".pt[5].px";
