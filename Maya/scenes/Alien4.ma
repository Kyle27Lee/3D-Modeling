...
//Name: Alien4.ma
//Last modified: Thu, Apr 03, 2014 12:35:42 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 3.0938534757415903 11.4003892588092 15.503750462736933 ;
	setAttr ".r" -type "double3" 358.46164726850299 -712.99999999997794 359.99999999993082 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 15.986010285321864;
...
createNode mesh -n "polySurfaceShape1" -p "polySurface1";
	...
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 25 ".pt";
	setAttr ".pt[82]" -type "float3" 0 7.4505806e-09 1.8626451e-09 ;
	setAttr ".pt[91]" -type "float3" 0.30544341 -0.11421841 -0.13494968 ;
	setAttr ".pt[137]" -type "float3" 0 -0.025692487 0 ;
	setAttr ".pt[139]" -type "float3" 0.038691949 0 0 ;
	setAttr ".pt[140]" -type "float3" 0 0.014241674 0 ;
	setAttr ".pt[141]" -type "float3" -0.07553456 -0.034727883 0 ;
	setAttr ".pt[144]" -type "float3" 0.01506108 0.015563083 0 ;
	setAttr ".pt[149]" -type "float3" 0 -0.038787123 0 ;
	setAttr ".pt[150]" -type "float3" 0 -0.027425451 0 ;
	setAttr ".pt[153]" -type "float3" 0 0 6.519258e-09 ;
	setAttr ".pt[178]" -type "float3" 3.7198181e-06 -0.013153441 3.0733645e-08 ;
	setAttr ".pt[331]" -type "float3" 0 -0.04419658 0 ;
	setAttr ".pt[332]" -type "float3" 0 -0.032502156 0 ;
	setAttr ".pt[441]" -type "float3" 0 -0.038787123 0 ;
	setAttr ".pt[445]" -type "float3" 0 -0.032502156 0 ;
	setAttr ".pt[477]" -type "float3" -0.038691949 0 0 ;
	setAttr ".pt[479]" -type "float3" -0.01506108 0.015563083 0 ;
	setAttr ".pt[626]" -type "float3" -0.30547374 -0.11421841 -0.13494968 ;
	setAttr ".pt[690]" -type "float3" 0.07553456 -0.034727883 0 ;
	setAttr ".pt[700]" -type "float3" 0 -0.04419658 0 ;
