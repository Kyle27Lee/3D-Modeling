...
//Name: 300cLayout.ma
//Last modified: Tue, Apr 15, 2014 09:08:38 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 9.6004746416806643 6.3056547467876856 2.4496664365020067 ;
	setAttr ".r" -type "double3" -3.9383527296494933 73.399999999968529 1.3916189125706972e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 8.2925744883070713;
...
createNode mesh -n "WindowRubberShape" -p "WindowRubber";
	...
	setAttr -s 36 ".pt[0:35]" -type "float3"  -0.42048895 -1.8530493 1.4901161e-08 
		...
		-0.83974779 -0.17696381 0.13164294 -0.83043528 0.039200597 1.0925108 -0.83043528 
		0.16935816 -0.34949195 -0.86734343 -0.084690109 0.058707669 -0.85624301 -0.10887469 
...
createNode mesh -n "DriverWindow" -p "pPlane9";
	...
	setAttr ".pt[4]" -type "float3" -0.30475995 1.0905602e-07 -0.46647212 ;
	setAttr ".pt[5]" -type "float3" 0.071118876 1.0905633e-07 0.43088609 ;
	setAttr ".pt[6]" -type "float3" -0.23959039 1.0905602e-07 0.12643054 ;
	setAttr ".pt[7]" -type "float3" -0.18175024 1.0905634e-07 1.8787235 ;
	setAttr ".pt[8]" -type "float3" -0.16613184 1.0905602e-07 -0.37799007 ;
	setAttr ".pt[9]" -type "float3" -0.12129457 1.090561e-07 0.69912559 ;
	setAttr ".pt[10]" -type "float3" -0.20003927 1.0905602e-07 -0.06144046 ;
	setAttr ".pt[11]" -type "float3" -0.18439278 0 0 ;
	setAttr ".pt[12]" -type "float3" -0.18439278 0 0 ;
	setAttr ".pt[14]" -type "float3" -0.040127069 1.0905602e-07 0.60720873 ;
	setAttr ".pt[15]" -type "float3" -0.79797339 1.0905602e-07 -0.17204003 ;
	setAttr ".pt[16]" -type "float3" -0.5900569 0 0 ;
	setAttr ".pt[17]" -type "float3" -0.42410338 0 0 ;
	setAttr ".pt[18]" -type "float3" 2.6090241e-15 0 0.33190703 ;
	setAttr ".pt[19]" -type "float3" -0.0039849877 1.0905602e-07 1.1549602 ;
	setAttr ".dn" yes;
