...
//Name: 300cLayout.ma
//Last modified: Mon, Apr 28, 2014 03:11:40 PM
//Codeset: UTF-8
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 41.127888701426428 18.566943364542592 13.754321251773256 ;
	setAttr ".r" -type "double3" -22.538352729647549 73.799999999938393 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 38.558636612211139;
...
createNode transform -s -n "side";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 100.1 5.9951105423117266 -2.2451087398425367 ;
	setAttr ".r" -type "double3" 0 89.999999999999986 0 ;
createNode camera -s -n "sideShape" -p "side";
	setAttr -k off ".v" no;
	setAttr ".rnd" no;
	setAttr ".coi" 100.1;
	setAttr ".ow" 1.5027636627783461;
...
createNode mesh -n "polySurfaceShape1" -p "DriverDoor";
	...
	setAttr ".dn" yes;
createNode transform -n "transform8" -p "DriverDoor";
	setAttr ".v" no;
createNode mesh -n "DriverDoorShape" -p "transform8";
	setAttr -k off ".v";
	setAttr ".io" yes;
...
createNode transform -n "pPlane5";
	setAttr ".t" -type "double3" 10.94830945162253 0 -12.564700875467125 ;
...
createNode transform -n "WindowRubber";
	...
	setAttr ".sp" -type "double3" -5.6505370080074047e-15 -6.0515021459227452 -7.5751102012915859e-16 ;
...
createNode mesh -n "polySurfaceShape2" -p "WindowRubber";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".dn" yes;
createNode transform -n "transform7" -p "WindowRubber";
	setAttr ".v" no;
createNode mesh -n "WindowRubberShape" -p "transform7";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "transform6" -p "pPlane9";
	setAttr ".v" no;
createNode mesh -n "DriverWindow" -p "transform6";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode mesh -n "polySurfaceShape4" -p "BackLeftDoor";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".dn" yes;
createNode transform -n "transform5" -p "BackLeftDoor";
	setAttr ".v" no;
createNode mesh -n "BackLeftDoorShape" -p "transform5";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr ".pt[73]" -type "float3"  0.030687155 0.0045542144 -0.058849961;
	setAttr ".dn" yes;
createNode transform -n "BackWindowRubber";
	...
	setAttr ".rp" -type "double3" -6.8011353154985044e-16 -7.0629590472575767 8.8817841970012523e-16 ;
	setAttr ".rpt" -type "double3" -7.0629590472575758 7.0629590472575758 0 ;
	setAttr ".sp" -type "double3" -1.7880397584440711e-15 -18.568740368949719 2.3350488607348497e-15 ;
	setAttr ".spt" -type "double3" 1.1079262268942198e-15 11.505781321692142 -1.4468704410347245e-15 ;
createNode mesh -n "polySurfaceShape5" -p "BackWindowRubber";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".dn" yes;
createNode transform -n "transform4" -p "BackWindowRubber";
	setAttr ".v" no;
createNode mesh -n "BackWindowRubberShape" -p "transform4";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".pt[19]" -type "float3" 0 -0.13471462 0 ;
	...
	setAttr ".pt[33]" -type "float3" -0.27411634 -1.2053161 -0.077031434 ;
...
createNode mesh -n "polySurfaceShape6" -p "BackLeftWindow";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".dn" yes;
createNode transform -n "transform3" -p "BackLeftWindow";
	setAttr ".v" no;
createNode mesh -n "BackLeftWindowShape" -p "transform3";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 20 ".pt[0:19]" -type "float3"  -0.44408149 -2.4082196 -1.834462e-07 
		-5.8259988e-09 0.36383551 1.4381175e-07 -0.40234235 -2.3619769 -4.8534872e-08 -1.3160206e-07 
		-0.65804452 2.3270225e-07 -1.8626451e-07 -1.6413047 1.1920929e-07 -0.45070499 -2.1657999 
		8.1140108e-09 -0.44408146 -2.4082196 -6.1658e-08 7.1054274e-15 -1.7828352 -0.041026559 
		7.4505806e-08 0.36383551 -9.8516708e-08 -0.44408137 -2.4082196 1.4606978e-07 1.7763568e-14 
		-1.7828352 -0.34188831 7.4505806e-08 0.36383551 1.3628014e-08 -0.44408146 -2.4082196 
		4.870103e-09 7.1054274e-15 -1.8865808 0 -5.5648787e-08 0.36383551 4.0555289e-08 -0.29892564 
		-0.88423759 -0.056603543 0.054702129 -0.85577005 -0.013675486 1.0880186e-14 -0.85577005 
		-0.32821274 0.027351052 -0.95951569 0.20513298 -0.25906789 -1.5125052 -0.15970547;
	setAttr ".dn" yes;
...
createNode mesh -n "polySurfaceShape7" -p "BackLeftFender";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".dn" yes;
createNode transform -n "transform2" -p "BackLeftFender";
	setAttr ".v" no;
createNode mesh -n "BackLeftFenderShape" -p "transform2";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
	...
	setAttr ".pt[5]" -type "float3" -3.5527137e-15 -0.13598135 0 ;
	setAttr ".pt[7]" -type "float3" 0.044275984 -0.18157838 0.11068993 ;
	setAttr ".pt[8]" -type "float3" 0.11589819 -0.58835751 0 ;
	setAttr ".pt[10]" -type "float3" -1.7763568e-15 -0.18157838 0 ;
	setAttr ".pt[11]" -type "float3" 0.12277906 -0.57859045 0 ;
	setAttr ".pt[13]" -type "float3" -3.5527137e-15 -0.13598135 0 ;
	setAttr ".pt[14]" -type "float3" -0.0099842884 -0.54502529 0 ;
	setAttr ".pt[16]" -type "float3" 0.088551953 -0.21988159 0.011068994 ;
	setAttr ".pt[17]" -type "float3" 0.074769393 -0.61587948 0 ;
	setAttr ".pt[19]" -type "float3" 0.088551953 -0.23780492 0.022137988 ;
	setAttr ".pt[20]" -type "float3" 0.042725369 -0.64458394 0 ;
	setAttr ".pt[22]" -type "float3" 0.044275977 -0.24679944 0 ;
	setAttr ".pt[23]" -type "float3" -8.8817842e-16 -0.67799819 0 ;
	setAttr ".pt[25]" -type "float3" 0 -0.26378432 0 ;
	setAttr ".pt[26]" -type "float3" -8.8817842e-16 -0.69440341 0 ;
	setAttr ".pt[27]" -type "float3" 0.0049921423 -0.53473866 0.074769393 ;
...
createNode mesh -n "polySurfaceShape8" -p "pPlane10";
	...
	setAttr ".hfd" -type "dataPolyComponent" Index_Data Face 0 ;
	setAttr ".dn" yes;
createNode transform -n "transform1" -p "pPlane10";
	setAttr ".v" no;
createNode mesh -n "pPlaneShape10" -p "transform1";
	setAttr -k off ".v";
	setAttr ".io" yes;
	setAttr -s 2 ".iog[0].og";
	setAttr ".vir" yes;
...
createNode transform -n "pPlane11";
	setAttr ".t" -type "double3" 10.94830945162253 0 -2.6008432802980632 ;
...
createNode polyTweak -n "polyTweak41";
	setAttr ".uopa" yes;
	setAttr -s 41 ".tk";
	setAttr ".tk[0]" -type "float3" -2.9786234e-08 -0.66050082 -1.9445987e-07 ;
	setAttr ".tk[1]" -type "float3" -2.9786234e-08 0.0038472814 2.1732447e-07 ;
	setAttr ".tk[2]" -type "float3" 0 -0.72243583 0 ;
	setAttr ".tk[5]" -type "float3" -2.9786234e-08 0.0038472814 -6.2665592e-08 ;
	setAttr ".tk[7]" -type "float3" -1.4899553e-07 0.0038472814 -4.4627419e-07 ;
	setAttr ".tk[9]" -type "float3" 4.4719574e-08 0.0038472814 4.5672274e-07 ;
	setAttr ".tk[11]" -type "float3" 8.9423054e-08 0.0038472814 -7.1644102e-08 ;
	setAttr ".tk[13]" -type "float3" -2.9786234e-08 0.0038472814 -3.7522608e-07 ;
	setAttr ".tk[15]" -type "float3" -2.9786234e-08 -0.11985763 4.6684701e-07 ;
	setAttr ".tk[16]" -type "float3" -8.8817842e-16 -0.32946131 0 ;
	setAttr ".tk[17]" -type "float3" -2.9786234e-08 -0.28129086 2.0644397e-07 ;
	setAttr ".tk[18]" -type "float3" 0 -0.72243583 0 ;
	setAttr ".tk[19]" -type "float3" -8.8817842e-16 -0.32946131 0 ;
	setAttr ".tk[20]" -type "float3" -8.8817842e-16 -0.13714683 0 ;
	setAttr ".tk[27]" -type "float3" 0 -0.72243583 0 ;
	setAttr ".tk[28]" -type "float3" -8.8817842e-16 -0.32946131 0 ;
	setAttr ".tk[29]" -type "float3" -8.8817842e-16 -0.13714683 0 ;
	setAttr ".tk[36]" -type "float3" 0 -0.72243583 0 ;
	setAttr ".tk[37]" -type "float3" -8.8817842e-16 -0.32946131 0 ;
	setAttr ".tk[38]" -type "float3" -8.8817842e-16 -0.13714683 0 ;
	setAttr ".tk[45]" -type "float3" -8.8817842e-16 -1.172747 -0.058908254 ;
	setAttr ".tk[46]" -type "float3" -8.8817842e-16 -1.1828067 0 ;
	setAttr ".tk[47]" -type "float3" -0.14927229 -1.6349231 0 ;
	setAttr ".tk[48]" -type "float3" -0.14927229 -1.7189896 0 ;
	setAttr ".tk[49]" -type "float3" -0.14927229 -1.67084 0 ;
	setAttr ".tk[50]" -type "float3" -0.14927229 -1.7169462 0 ;
	setAttr ".tk[51]" -type "float3" -0.14927229 -1.67084 0 ;
	setAttr ".tk[52]" -type "float3" -0.14927229 -1.7169462 0 ;
	setAttr ".tk[53]" -type "float3" -0.14927229 -1.6830801 0 ;
	setAttr ".tk[54]" -type "float3" -0.14927229 -1.7169462 0 ;
	setAttr ".tk[55]" -type "float3" -0.16608727 -1.6831149 -1.4948345e-07 ;
	setAttr ".tk[56]" -type "float3" -0.16608727 -1.7163134 -5.3236204e-07 ;
	setAttr ".tk[57]" -type "float3" 0 -0.72243583 0 ;
	setAttr ".tk[58]" -type "float3" -8.8817842e-16 -0.32946131 0 ;
	setAttr ".tk[59]" -type "float3" -8.8817842e-16 -0.13714683 0 ;
	setAttr ".tk[66]" -type "float3" -0.14927229 -1.7169462 0 ;
	setAttr ".tk[67]" -type "float3" -0.14927229 -1.6812791 0 ;
	setAttr ".tk[68]" -type "float3" -0.14927229 -1.7169462 0 ;
	setAttr ".tk[69]" -type "float3" -0.14927229 -1.6830801 0 ;
	setAttr ".tk[70]" -type "float3" -0.16750856 -1.7169462 -0.085549384 ;
	setAttr ".tk[71]" -type "float3" -0.15284134 -1.67084 0.11179425 ;
...
connectAttr ":initialShadingGroup.mwc" "DriverDoorShape.iog.og[0].gco";
connectAttr "groupParts1.og" "DriverDoorShape.i";
connectAttr "groupId2.id" "DriverDoorShape.ciog.cog[0].cgid";
connectAttr "groupId3.id" "WindowRubberShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "WindowRubberShape.iog.og[0].gco";
connectAttr "groupParts2.og" "WindowRubberShape.i";
connectAttr "groupId4.id" "WindowRubberShape.ciog.cog[0].cgid";
connectAttr "groupId5.id" "DriverWindow.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "DriverWindow.iog.og[0].gco";
connectAttr "groupParts3.og" "DriverWindow.i";
connectAttr "groupId6.id" "DriverWindow.ciog.cog[0].cgid";
connectAttr "groupId7.id" "BackLeftDoorShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "BackLeftDoorShape.iog.og[0].gco";
connectAttr "groupParts4.og" "BackLeftDoorShape.i";
connectAttr "groupId8.id" "BackLeftDoorShape.ciog.cog[0].cgid";
connectAttr "groupId9.id" "BackWindowRubberShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "BackWindowRubberShape.iog.og[0].gco";
connectAttr "groupParts5.og" "BackWindowRubberShape.i";
connectAttr "groupId10.id" "BackWindowRubberShape.ciog.cog[0].cgid";
connectAttr "groupId11.id" "BackLeftWindowShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "BackLeftWindowShape.iog.og[0].gco";
connectAttr "groupParts6.og" "BackLeftWindowShape.i";
connectAttr "groupId12.id" "BackLeftWindowShape.ciog.cog[0].cgid";
connectAttr "groupId13.id" "BackLeftFenderShape.iog.og[0].gid";
connectAttr ":initialShadingGroup.mwc" "BackLeftFenderShape.iog.og[0].gco";
connectAttr "groupParts7.og" "BackLeftFenderShape.i";
connectAttr "groupId14.id" "BackLeftFenderShape.ciog.cog[0].cgid";
...
connectAttr "polyTweak41.out" "polySplitRing102.ip";
connectAttr "BackLeftDoorShape.wm" "polySplitRing102.mp";
connectAttr "polySplitRing72.out" "polyTweak41.ip";
connectAttr "DriverDoorShape.o" "polyUnite1.ip[0]";
connectAttr "WindowRubberShape.o" "polyUnite1.ip[1]";
connectAttr "DriverWindow.o" "polyUnite1.ip[2]";
connectAttr "BackLeftDoorShape.o" "polyUnite1.ip[3]";
connectAttr "BackWindowRubberShape.o" "polyUnite1.ip[4]";
connectAttr "BackLeftWindowShape.o" "polyUnite1.ip[5]";
connectAttr "BackLeftFenderShape.o" "polyUnite1.ip[6]";
connectAttr "pPlaneShape10.o" "polyUnite1.ip[7]";
connectAttr "DriverDoorShape.wm" "polyUnite1.im[0]";
connectAttr "WindowRubberShape.wm" "polyUnite1.im[1]";
connectAttr "DriverWindow.wm" "polyUnite1.im[2]";
connectAttr "BackLeftDoorShape.wm" "polyUnite1.im[3]";
connectAttr "BackWindowRubberShape.wm" "polyUnite1.im[4]";
connectAttr "BackLeftWindowShape.wm" "polyUnite1.im[5]";
connectAttr "BackLeftFenderShape.wm" "polyUnite1.im[6]";
connectAttr "pPlaneShape10.wm" "polyUnite1.im[7]";
connectAttr "polySplitRing101.out" "groupParts1.ig";
connectAttr "groupId1.id" "groupParts1.gi";
connectAttr "deleteComponent2.og" "groupParts2.ig";
connectAttr "groupId3.id" "groupParts2.gi";
connectAttr "polySplitRing44.out" "groupParts3.ig";
connectAttr "groupId5.id" "groupParts3.gi";
connectAttr "polySplitRing102.out" "groupParts4.ig";
connectAttr "groupId7.id" "groupParts4.gi";
connectAttr "polySplitRing79.out" "groupParts5.ig";
connectAttr "groupId9.id" "groupParts5.gi";
connectAttr "polySplitRing77.out" "groupParts6.ig";
connectAttr "groupId11.id" "groupParts6.gi";
connectAttr "polySplitRing88.out" "groupParts7.ig";
connectAttr "groupId13.id" "groupParts7.gi";
connectAttr "polySplitRing97.out" "groupParts8.ig";
connectAttr "groupId15.id" "groupParts8.gi";
connectAttr "polyUnite1.out" "groupParts9.ig";
connectAttr "groupId17.id" "groupParts9.gi";
connectAttr "polySurfaceShape9.o" "polySeparate1.ip";
...
connectAttr "DriverDoorShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "DriverDoorShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "WindowRubberShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "WindowRubberShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "DriverWindow.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "DriverWindow.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackLeftDoorShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackLeftDoorShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackWindowRubberShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackWindowRubberShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackLeftWindowShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackLeftWindowShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackLeftFenderShape.iog.og[0]" ":initialShadingGroup.dsm" -na;
connectAttr "BackLeftFenderShape.ciog.cog[0]" ":initialShadingGroup.dsm" -na;
