...
//Name: AlienModel.ma
//Last modified: Tue, Feb 18, 2014 09:34:55 AM
//Codeset: 1252
requires maya "2014";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -5.7085387788882471 5.6105422867555266 24.632063602905863 ;
	setAttr ".r" -type "double3" 1.4616472703448935 343.39999999974464 -2.5928725995873733e-017 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr ".coi" 25.509795334954671;
...
createNode transform -s -n "front";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -0.077166158987143518 -3.7401981294693942 100.1 ;
...
createNode transform -n "pPlane1";
	...
	setAttr ".r" -type "double3" 94.798078679351477 -6.1760456215078472 89.809274772037696 ;
...
createNode transform -n "pPlane2";
	setAttr ".t" -type "double3" -0.019763683888727627 14.097739071309585 0.19198811223586909 ;
	setAttr ".r" -type "double3" 94.798078679351477 -6.1760456215078472 89.809274772037696 ;
	setAttr ".s" -type "double3" 0.66028972843501044 0.66028972843501044 0.66028972843501044 ;
createNode mesh -n "pPlaneShape2" -p "pPlane2";
	...
	setAttr ".vif" yes;
	setAttr ".uvst[0].uvsn" -type "string" "map1";
	setAttr -s 4 ".uvst[0].uvsp[0:3]" -type "float2" 0 0 1 0 0 0.57948184
		 1 0.57948184;
	setAttr ".cuvs" -type "string" "map1";
	setAttr ".dcc" -type "string" "Ambient+Diffuse";
	setAttr ".covm[0]"  0 1 1;
	setAttr ".cdvm[0]"  0 1 1;
	setAttr -s 4 ".vt[0:3]"  -2.75742388 -3.5479997e-016 1.59787703 2.75742388 -3.5479997e-016 1.59787703
		 -2.75742388 3.5479997e-016 -1.59787703 2.75742388 3.5479997e-016 -1.59787703;
...
createNode hyperLayout -n "hyperLayout1";
	...
	setAttr ".hyp[5].x" -194.76190185546875;
	setAttr ".hyp[5].y" -75;
...
connectAttr "file3.oc" "alien.c";
connectAttr "alien.oc" "lambert2SG.ss";
connectAttr "pCubeShape1.iog" "lambert2SG.dsm" -na;
connectAttr "lambert2SG.msg" "materialInfo1.sg";
connectAttr "alien.msg" "materialInfo1.m";
...
connectAttr "alien.msg" "hyperLayout1.hyp[0].dn";
...
connectAttr "alien.msg" ":defaultShaderList1.s" -na;
