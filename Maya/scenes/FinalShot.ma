...
//Name: FinalShot.ma
//Last modified: Mon, Apr 21, 2014 12:29:56 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -456.83726356456066 174.76913693144496 175.65726308810062 ;
	setAttr ".r" -type "double3" -19.538352729496598 -68.19999999998619 8.5644322878666919e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 537.87277810970318;
...
createNode camera -n "Final_CameraShape" -p "Final_Camera";
	...
	setAttr ".ff" 0;
	setAttr ".coi" 40.074868766683707;
	setAttr ".ow" 30;
...
createNode transform -n "directionalLight3";
	...
	setAttr ".r" -type "double3" -314.95603058918039 105.12395010693875 -253.88897379618044 ;
