...
//Name: FinalShot.ma
//Last modified: Mon, Apr 21, 2014 09:45:47 AM
//Codeset: UTF-8
...
file -rdi 1 -ns "Alien4UV" -rfn "Alien4UVRN" "/Users/temp/Desktop/3D-Modeling/Maya//scenes/Alien4UV.ma";
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" 19.859244329408888 -12.020354029247489 -61.715934513640143 ;
	setAttr ".r" -type "double3" 3.2616472704038375 -189.39999999997676 0 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 58.060866571404361;
...
createNode camera -n "Final_CameraShape" -p "Final_Camera";
	...
	setAttr ".ff" 0;
	setAttr ".coi" 4.9999999999999316;
	setAttr ".ow" 30;
...
createNode transform -n "Alien4UVRNlocator";
	setAttr ".t" -type "double3" 6.8674272291027432 -9.832757850045482 -3.8370238338735145 ;
	setAttr ".r" -type "double3" 57.410960009776993 -100.18232201321533 -79.66893834215945 ;
	setAttr ".s" -type "double3" 0.1135461008478756 0.1135461008478756 0.1135461008478756 ;
	setAttr ".rp" -type "double3" 0.097437657628185903 6.0885610710801048 -0.2746841897704303 ;
	setAttr ".sp" -type "double3" 0.097437657628185903 6.0885610710801048 -0.2746841897704303 ;
createNode locator -n "Alien4UVRNlocatorShape" -p "Alien4UVRNlocator";
	setAttr -k off ".v";
	setAttr ".lp" -type "double3" 0.097437657628185903 6.0885610710801048 -0.2746841897704303 ;
...
createNode transform -n "Alien4UVRNannotation" -p "Alien4UVRNlocator";
	setAttr ".t" -type "double3" 0.097437657628185903 6.0885610710801048 -0.2746841897704303 ;
createNode annotationShape -n "Alien4UVRNannotationShape" -p "Alien4UVRNannotation";
	setAttr -k off ".v";
	setAttr ".txt" -type "string" "Alien4UVRN";
	setAttr ".daro" no;
createNode transform -n "directionalLight1";
	setAttr ".t" -type "double3" 11.020998817470998 -3.4175528031451394 -10.56741569840085 ;
	setAttr ".r" -type "double3" -113.33900774116577 119.46711299550357 -88.484457390196638 ;
createNode directionalLight -n "directionalLightShape1" -p "directionalLight1";
	setAttr -k off ".v";
	setAttr ".in" 1.2173912525177002;
createNode transform -n "directionalLight2";
	setAttr ".t" -type "double3" 4.7307035923681919 1.83526246295002 -11.269630761517149 ;
	setAttr ".r" -type "double3" -364.49049721984187 105.12395010693888 -253.88897379618038 ;
...
createNode transform -n "pPlane1";
	setAttr ".t" -type "double3" 7.9883889075989156 -6.303297555156953 -9.6005660884718065 ;
	setAttr ".r" -type "double3" -6.0320229225455186 -21.852469217778118 -27.557015391329447 ;
	setAttr ".s" -type "double3" 1.8364782426459951 1.8364782426459951 1.8364782426459951 ;
...
createNode reference -n "Jeep2RN";
	...
	setAttr ".ed" -type "dataReferenceEdits" 
		...
		2 "|Jeep2RNlocator|Jeep2RNgroup|Jeep2:polySurface127" "translate" " -type \"double3\" 6.659392 -5.359205 -10.680604"
		
		2 "|Jeep2RNlocator|Jeep2RNgroup|Jeep2:polySurface127" "rotate" " -type \"double3\" 6.840343 156.501407 -27.571665"
