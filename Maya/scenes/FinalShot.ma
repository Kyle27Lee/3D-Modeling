...
//Name: FinalShot.ma
//Last modified: Mon, Apr 21, 2014 12:17:42 PM
//Codeset: UTF-8
...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -118.84463539249241 50.555276365158385 25.606281590207921 ;
	setAttr ".r" -type "double3" -23.138352729485153 -76.999999999995765 -7.0694371509827121e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 143.21815253201763;
...
createNode transform -n "ShadowBackground";
	...
	setAttr ".s" -type "double3" 0.97406088436448812 1.8364782426459951 0.56655624101458701 ;
...
createNode transform -n "pointLight2";
	setAttr ".t" -type "double3" 2.3234468858269217 -3.4585191333829761 -12.82605197506912 ;
