...
createNode transform -s -n "persp";
	setAttr ".v" no;
	setAttr ".t" -type "double3" -35.092477335782284 40.348357523873332 40.882984114839033 ;
	setAttr ".r" -type "double3" -37.538352729594607 -34.999999999999652 1.9413701666484663e-15 ;
createNode camera -s -n "perspShape" -p "persp";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 68.778224648166514;
...
createNode transform -n "Alien4UVRNlocator";
	...
	setAttr ".s" -type "double3" 0.11354610084787561 0.11354610084787561 0.11354610084787561 ;
